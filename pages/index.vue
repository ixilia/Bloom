<template>
  <v-col justify="space-between" style="overflow-x: hidden" >
    ...
    <h1 v-if="$vuetify.breakpoint.smAndUp" class="pb-3" style="-webkit-touch-callout: none; -webkit-user-select: none; user-select: none; font-size: 4rem; text-align: center;  background: linear-gradient(#eee, #333);  -webkit-background-clip: text;  -webkit-text-fill-color: transparent;">From Hina</h1>
    <h1 v-if="$vuetify.breakpoint.xsOnly" class="pb-3" style="-webkit-touch-callout: none; -webkit-user-select: none; user-select: none; font-size: 2.5rem; text-align: center;  background: linear-gradient(#eee, #333);  -webkit-background-clip: text;  -webkit-text-fill-color: transparent;">From Hina</h1>
...
<script>
  ...
  export default {
      ...
      return {
        items: [{
        ...
        },
          {
            ...
            "source": "www.jkforum.net",
            "color": ["#b3c425", "#efb598", "#426608", "#ac835b", "#d0aa9c", "#6d5e56"]
          },
          {
            "id": "vMwxOLp7",
            "name": "曉美媽 – 惡墮★快感之牢 [33P]",
            ...
            "source": "www.jkforum.net",
            "color": ["#33a0be", "#dcab92", "#3f8c9a", "#a17b69", "#d8bea9", "#343332"]
          },
          {
            "id": "vMwxOLp7",
            "name": "曉美媽 – 惡墮★快感之牢 [33P]",
        ...
        itemsd: [
          {
            ...
            "name": "曉美媽 – 惡墮★快感之牢 [33P]",
            "idol": "Unknown",
            "thumb": "https://www.mymypic.net/data/attachment/forum/202006/25/0800557uazw6vwx6w4t7ug.jpg",
            "source": "www.jkforum.net",
            "color": ["#fc1c64", "#f87a75", "#760624", "#974c4c", "#bc796e", "#5c3c34"]
          },
          {
            ...
            "name": "曉美媽 – 惡墮★快感之牢 [33P]",
            "idol": "Unknown",
            "thumb": "https://www.mymypic.net/data/attachment/forum/202006/25/080108aqjqc44t58u11zck.jpg",
            "source": "www.jkforum.net",
            "color": ["#fc1c64", "#f87a75", "#760624", "#974c4c", "#bc796e", "#5c3c34"]
          },
          {
    ...
    methods: {
      GetAndSA() {
        this.$axios.get('https://api.ixil.cc/bloom/hina?op=50&page=1&source=www.jkforum.net').then(function(response) {
          // handle success
          const parsed = JSON.stringify(response.data.data);
          localStorage.setItem('recent', parsed);
